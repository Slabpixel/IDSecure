...
(function () {
  ...
  var mediaItems = gsap.utils.toArray(root.querySelectorAll('.ent-solutions_media-item'));
  var copyItems = gsap.utils.toArray(root.querySelectorAll('.ent-solutions_copy-item'));
  var navItems = gsap.utils.toArray(root.querySelectorAll('.ent-solution_navigation-item'));
